...
function AddATask() {
	...
	if (contentTask !== '') {
		...
		listItem.innerHTML = `
            <div>${contentTask}</div>
            <div class="editTask">
                <button class="update ${(listItem.id = taskId)}" onclick='updateTask("${taskId}")'>
									<img src="./assets/update.svg" alt="" 
									></button> 
                <button class="btn-erase ${(listItem.id =
									taskId)}"><img src="./assets/delete.svg" alt=""></button>
                <button class="btn-done ${(listItem.id =
									taskId)}"><img src="./assets/done.svg" alt=""></button>
            </div>
        `;
