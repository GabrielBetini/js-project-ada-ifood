...
function AddATask() {
	...
	if (contentTask !== '') {
		...
		listItem.innerHTML = `
            <div>${contentTask}</div>
            <div class="editTask">
                <button class="update" data-task-id="${taskId}" onclick="updateTask(this)"> <img src="./assets/update.svg" alt=""></button> 
	...
	if (storedTasks) {
		...
		tasks.forEach(task => {
			...
			listItem.innerHTML = `
                ...
                <div class="editTask">
                    <button class="update" data-task-id="${task.id}" onclick="updateTask(this)"><img src="./assets/update.svg" alt=""></button> 
